...
RUN ARCH="$(dpkg --print-architecture)" \
    ...
    *) echo "Unsupported architecture: ${ARCH}" >&2; exit 1 ;; \
    ...
    && apt-get update && apt-get install -y xz-utils ca-certificates rsync netcat-openbsd \
...
# Install OpenClaw (formerly clawdbot, renamed upstream ~Jan 30, 2026)
...
# Copy startup script
# Build cache bust: 2026-02-12-v78-upgrade-to-openclaw-2026.2.9
